...
| Week | Milestone                                   | Link                                                                        |      
|------|---------------------------------------------|-----------------------------------------------------------------------------|
| 1    | Github Account Created                      | https://github.com/amidecar                                               | 
| 1    | Github Profile Page                         | https://github.com/amidecar/amidecar                                    |
| 1    | Commit and Push Change from Command Line    | https://github.com/amidecar/ppchem/commit/91d72f66fe422e5638648543d6f743c17edd2a09               |
...
| 2    | (Optional) Review a Pull Request            | https://github.com/schwallergroup/practical-programming-in-chemistry-milestones/pull/16#pullrequestreview-1936742234
| 4    | Update `env.yml` via a Pull Request         | https://github.com/amidecar/ppchem/pull/1#issue-2186531599
